...
//	}
	...
	#if LINUX_VERSION_CODE < KERNEL_VERSION(4,19,291) || LINUX_VERSION_CODE >= KERNEL_VERSION(4,20,0)
	static inline void eth_hw_addr_set(struct net_device *dev, const u8 *addr)
	{
		memcpy(dev->dev_addr, addr, 6);
	}
	#endif /* LINUX_VERSION_CODE < KERNEL_VERSION(4,19,291) || LINUX_VERSION_CODE >= KERNEL_VERSION(4,20,0) */
